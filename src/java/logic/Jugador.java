...
public class Jugador {
    ...
    private List<CartaDesarrollo> cartasDesarrollo = new ArrayList<>();
    ...
    public void agregarCartaDesarrollo(CartaDesarrollo carta) {
        cartasDesarrollo.add(carta);
    }

    public List<CartaDesarrollo> getCartasDesarrollo() {
